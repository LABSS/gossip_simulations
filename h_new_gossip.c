...
//ERRORI BIDIREZIONALI (cattivi segnalati come buoni, e viceversa), UGUALE PESO DI ESPERIENZA DIRETTA E GOSSIP
#include<stdio.h>   
#include<stddef.h>
#include<stdlib.h>
#include<math.h>
...
#define P_ERR 0.15             //probabilità errore di trasmissione info
